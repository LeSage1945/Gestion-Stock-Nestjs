...
export class VenteService {
  ...
  async create(dto: any, compteId: string) {
    ...
    // On récupère tous les produits concernés en UNE seule requête
    ...
    // Une seule requête groupée pour les entrées de stock
    ...
    // Une seule requête groupée pour les sorties de stock
    ...
    return this.prisma.$transaction(async (tx) => {
      ...
      // ================= LIGNES + SORTIES (créées en masse) =================
